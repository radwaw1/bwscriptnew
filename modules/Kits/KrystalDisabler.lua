...
KrystalDisabler.Enabled = false

local killConnection = nil

KrystalDisabler.Run = function()
    KrystalDisabler.Enabled = not KrystalDisabler.Enabled

    if KrystalDisabler.Enabled then
        task.wait(3)
        ...
        -- Kill again on respawn (only once)
        ...
        print("❌ KrystalDisabler Disabled")
